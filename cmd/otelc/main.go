...
func newBuildCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			// Create a dummy file with all telemetry dependencies so 'go build' orchestrator
			// resolves them and puts them in importcfg.
			dummyFile := "otelc_deps_dummy.go"
			dummyContent := `// Code generated by otelc. DO NOT EDIT.
package main
import (
	_ "context"
	_ "fmt"
...
`
			os.WriteFile(dummyFile, []byte(dummyContent), 0644)
